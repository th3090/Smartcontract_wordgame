...
class Main extends Component {
  ...
  render() {
    return (
      ...
      <div className='container'>
        <button className='btn btn-danger btn-lg' onClick={this.summit}>Summit!</button>
      </div>

      <div className='container'>
        <button className='btn btn-danger btn-lg' onClick={this.distribute}>Distribute!</button>
      </div>
